...
class QuoteTool(BaseTool):
    ...
    FALLBACK_QUOTES = [
        {"content": "النجاح ليس نهائياً، والفشل ليس قاتلاً: إنها الشجاعة للاستمرار هي ما يهم.", "author": "وينستون تشرشل"},
        {"content": "الطريقة الوحيدة للقيام بعمل عظيم هي أن تحب ما تفعله.", "author": "ستيف جوبز"},
        {"content": "ابدأ من حيث أنت، استخدم ما لديك، وافعل ما تستطيع.", "author": "آرثر آش"},
        {"content": "الإيمان هو الطير الذي يشعر بالنور عندما يكون الفجر لا يزال مظلماً.", "author": "طاغور"},
        {"content": "لا تخف من الفشل، بل خف من عدم المحاولة.", "author": "روي بينيت"},
        {"content": "المستقبل ينتمي لأولئك الذين يؤمنون بجمال أحلامهم.", "author": "إليانور روزفلت"},
